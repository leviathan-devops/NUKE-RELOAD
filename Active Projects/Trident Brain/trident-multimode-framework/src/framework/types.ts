 ...
 * 
 * Shared codebase for all Trident Brain plugins.
 * This module provides:
 * - Base plugin class
 * - State machine for layer management
 * - Gate validator for mechanical enforcement
 * - Artifact generator for report creation
 * - Shared types
 */

export { BaseTridentPlugin } from './base-plugin.js';
export { StateMachine, type TridentState, type LayerTransition } from './state-machine.js';
export { GateValidator, type GateRequirement } from './gate-validator.js';
 ...
 * 
 * All Trident modes are documentation-only.
 * They NEVER edit code - only generate artifacts.
 */
...
export interface GateRequirement {
  ...
  value?: any;
  validate?: (artifacts: Map<string, string>) => boolean;
}
