...
const WORKSPACE = process.env.OPENCODE_WORKSPACE || process.cwd() || path.join(HOME, 'OPENCODE_WORKSPACE');
const WRAPPERS_DIR = path.join(WORKSPACE, 'plugins', 'opencode-subagent-manager', 'wrappers');
